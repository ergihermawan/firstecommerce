...
use App\Http\Livewire\Admin\AdminAddCategooryComponent;
...
Route::middleware(['auth:sanctum', 'verified', 'authadmin'])->group(function () {
    ...
    Route::get('/admin/category/add', AdminAddCategooryComponent::class)->name('admin.addcategory');
    ...
    Route::get('/admin/add', AdminAddHomeSliderComponent::class)->name('admin.addhomeslider');
